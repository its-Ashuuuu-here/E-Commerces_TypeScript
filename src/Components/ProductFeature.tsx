    ...
    <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-2">
      <div className="lg:pr-8 lg:pt-4">
        <div className="lg:max-w-lg">
          <h2 className="text-base font-semibold leading-7 text-indigo-600">Produce 2023</h2>
          <p className="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Prada Re-Edition 2023 Re-Nylon Bag</p>
          <p className=" text-lg leading-8 text-gray-600"> Best Product 2023
          </p>
          <dl className="mt-0 max-w-xl space-y-8 text-base leading-7 text-gray-600 lg:max-w-none">
            <div className="relative pl-9 cursor-pointer">
      ...
      </div><img src="../Assest/bgs.jpg" alt="Product screenshot" 
      className=" mt-20 rounded-xl shadow-xl ring-1 ring-gray-400/10 sm:w-[57rem] md:-ml-4 lg:-ml-0  hover:scale-110 ease-linear duration-200 cursor-pointer " 
      width="800px" height="1442"/>
    </div>
  </div>
</section>
