...
const HighlightSer = () => {
  return (
    <div>
      <div className="max-w-screen-xl mx-auto py-8 px-4 lg:py-16 lg:px-6 cursor-pointer">
    ...
    <div className="flex flex-col md:flex-row  ">
        ...
        {/* <div className="mr-0 md:mr-8 mb-6 md:mb-0 mt-20">
            <img className="w-1/2 md:w-full mx-auto hover:scale-110 ease-linear duration-200" src="../Assest/1.jpg" alt="can_help_banner" />
        </div> */}
